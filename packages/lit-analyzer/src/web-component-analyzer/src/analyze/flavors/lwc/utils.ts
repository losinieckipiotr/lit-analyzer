...
export function getLwcComponent(
  node: Node,
...
function _isLwcComponent(
  ...
  if (
    flags & context.ts.ModifierFlags.ExportDefault &&
    (jsName.endsWith(".js") || jsName.endsWith(".ts"))
  ) {
